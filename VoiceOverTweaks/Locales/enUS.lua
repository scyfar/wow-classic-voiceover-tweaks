...
L.DELAY_OVERRIDES_MANAGE_BUTTON = "Manage Overrides..."

L.TAB_SILENCE = "Silence"
L.SILENCE_DESCRIPTION = "Silence specific NPCs or lines spoken by the VoiceOver addon.\n"
...
L.SILENCE_NPCS_MANAGE_BUTTON = "Manage Silenced NPCs..."
L.SILENCE_LINES_MANAGE_BUTTON = "Manage Silenced Lines..."

-- Table dialog (shared by the Delay Overrides / Silenced NPCs / Silenced Lines management windows)
L.COL_ID = "ID"
L.COL_NAME = "Name"
L.COL_DELAY = "Delay (s)"
L.COL_LINE = "Line"
L.ROW_REMOVE_TOOLTIP = "Click to remove"
L.DIALOG_SEARCH_LABEL = "Search:"
L.DIALOG_TITLE_DELAY_OVERRIDES = "Delay Overrides"
L.DIALOG_TITLE_SILENCED_NPCS = "Silenced NPCs"
L.DIALOG_TITLE_SILENCED_LINES = "Silenced Lines"
